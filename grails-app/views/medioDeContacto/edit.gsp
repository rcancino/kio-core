...
<html>
	...
	<body>
		<a href="#edit-medioDeContacto" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-medioDeContacto" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:medioDeContactoInstance, action:'update']" method="PUT" >
